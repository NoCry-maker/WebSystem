                    ...
                    <div class="row ">
                        <div class="col-sm-6 col-lg-3">
                            <div class="widget widget-about">
                                ...
                                <!-- End .widget-title -->
                                <p class="">Praesent dapibus, neque id cursus ucibus, tortor neque egestas
                                    augue, eu vulputate
            ...
            <div class="footer-bottom ">
                <div class="container">
                    <figure class="footer-payments ">
                        ...
                        <img src="new-assets/images/payments.png" alt="Payment methods" width="272" height="20">
                    </figure><!-- End .footer-payments -->
                    <img src="new-assets/images/logo.png" alt="Bankero Logo" width="82" height="25">
                    <p class="footer-copyright ">© {{ date('Y') }} BankeroBay. All Rights Reserved.</p>
