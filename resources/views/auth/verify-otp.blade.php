    ...
    <div class="text-center bg-white px-8 sm:px-16 py-8 rounded-2xl  mt-10 mx-auto">
        ...
        <form method="POST" action="{{ route('otp.verify') }}">
            ...
            <div class="text-center">
                <button type="submit" class="px-4 py-3 mb-2 rounded-md bg-indigo-600 text-white w-[400px]">
                    {{ __('Next') }}
                </button>
            </div>
        </form>
        <div class="text-md text-slate-500 mb-4">
            ...
            <form id="resend-form" method="POST" action="{{ route('otp.resend.register') }}">
                ...
                <button id="resend-btn" type="submit"
                    class="font-medium text-indigo-500 hover:text-indigo-600 @if ($remaining > 0) d-none @endif">
                    Resend code
                </button>
            </form>
        </div>
